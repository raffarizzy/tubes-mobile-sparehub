...
import 'toko_halaman/editToko.dart';
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    final result = await Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => EditTokoPage(toko: tokoInfo!),
                                      ),
                                    );

                                    if (result == true) {
                                      setState(() => isLoading = true);
                                      _loadTokoData(); // reload dari Firestore
                                    }
                                  },
                                ),
                              ],
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Lacak(tokoId: tokoId!,)),
                );
              },
              child: BottomButton(
