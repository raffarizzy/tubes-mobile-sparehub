...
class _DetailProdukState extends State<DetailProduk> {
  ...
  Future<UserModel?> _getUserCached(String userId) {
    if (!_userFutureCache.containsKey(userId)) {
      _userFutureCache[userId] = _userService.getUserById(userId);
    }
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return ListTile(
                                          leading: FutureBuilder<UserModel?>(
                                            future: _getUserCached(rating.userId),
                                            builder: (context, snapshot) {
                                              ...
                                              // === JIKA USER TIDAK ADA / FOTO KOSONG ===
                                              if (user == null ||
                                                  user.imagePath == null ||
